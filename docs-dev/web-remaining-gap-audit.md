...
- `mcp`、`omo`、`openclaw`、`import_export`、`settings`、`webdav_sync`、`usage`、`skill`、`stream_check`、`provider` 模块中仅供旧桌面命令层复用的 public wrapper 已删除，Web handler 统一直接走 `commands/*_internal`
